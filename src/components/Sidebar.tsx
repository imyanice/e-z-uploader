      ...
      {minimized ? (
        ...
        >
          <nav className="p-4 min-[900px]:block hidden">
            ...
            <ul className="flex flex-col mt-4 gap-y-2">
              <li className="text-blue-100 gap-y-1 rounded-md bg-zinc-900">
                <button
                  onClick={() => router.push(`/`)}
                  className={`${page === 'dash'
          ...
          <button
            onClick={maximize}
            className="bg-zinc-800 w-full p-2 mt-auto text-white flex flex-row text-2xl px-8"
          >
            <>
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <nav className="p-4 min-[900px]:block hidden duration-300">
            <svg className="h-20 w-20 mx-auto cursor-pointer" id="Layer_1" data-name="Layer 1"
              xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1011.67 806.28">
              <g id="Layer_13" data-name="Layer 13">
                <g>
                  <path className="sidebar-2"
